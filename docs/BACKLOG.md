...
3. **Audit du Council à 8 agents (Clôturé & Rejeté - ADR 0028)** : Audit du Council déterministe (`domain/council.py`) avec veto strict et 5 agents de stratégie actifs (Trend, Momentum, Volatility, Pattern, Portfolio) sur 75k barres M1 (Gold, Crash 1000). Le consensus émet ~97% de trades à rendement brut nul (0.00 bps), produisant un P&L net négatif (-1.91 bps sur Gold, -0.73 bps sur Crash 1000). Réfuté sur M1.
